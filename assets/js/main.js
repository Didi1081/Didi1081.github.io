...
(function ($) {
	...
	var data = ["Hi! I'm Didi!", "...well that's what they call me.", "Pleasure to meet you.", "I'm a fullstack developer!", "Please look at my work below.", "Click that arrow button below...↙️", "..it will take you to the projects!", "You can also scroll down...🖱️", "...or use the nav bar on top. ↗️", "Have fun!", "What are you waiting for?", "Nothing else to see here.", "Still here?", "humm...🤔", "", "Are you entertained?", "Do you just want to see how long this goes on for?", "What if I go for 3 hours?", "I could tell you my entire life story...", "Want to hear it?", "If you want to hear my story, contact me.", "I'll tell you IRL!", "Well... it was nice to meet you.", "See you later and take care.", "Enjoy your lunch. 🍕 ", "Seriously, you may click on the arrow now.", "Goodbye!", "Sayonara!", "Hasta la vista!", "Ok, I'm really done now, byeee.", "", "You're going to just see the cursor if you stay...", "", "", "", "", "", "", "", "Just incase you missed it..."];
	var j = 0;
	var i = 0;
